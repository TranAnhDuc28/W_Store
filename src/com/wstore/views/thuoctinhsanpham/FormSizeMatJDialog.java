 ...
 * @author ducan
 */
public class FormSizeMatJDialog extends javax.swing.JDialog {

    /**
     * Creates new form FormSizeMatJDialog
     */
    public FormSizeMatJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormSizeMatJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormSizeMatJDialog dialog = new FormSizeMatJDialog(new javax.swing.JFrame(), true);
